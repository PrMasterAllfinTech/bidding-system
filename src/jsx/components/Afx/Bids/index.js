...
function ActiveBids(props) {
    ...
    const postData = {order_type: "" , status: "", customer_id: customer_id, show_account_detail:1, show_order_detail:1, is_bid:"1"};
    ...
    useEffect(async () => {
        try {
            const response = await axios.get(`trades/bids/${customer_id}`).then((res) => {
    ...
    return(
        <Fragment>
            ...
            <div className="row justify-content-center mb-4">
                <div className="col-12 text-center"><h3 className={"fc-dark-grey"}>Bids Made</h3></div>
            </div>
