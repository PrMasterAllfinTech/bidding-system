            ...
            <Fragment>
                <Row className={"justify-content-center"}>
                    <div className="col-12">
                        <div className="row justify-content-center mb-4"><h3>Accounts</h3></div>
                        <div className="row justify-content-center my-4 py-2 ">
                            <div className="col-2">
                                <SearchOptions type={"Fiat"} options={fiats} setSearch={setSearch} query={query}/></div>
                            <div className="col-2">
                                <SearchOptions type={"Asset"} options={assets} setSearch={setSearch} query={query}/></div>
                            <div className="col-2"><AddPayment /></div>
                        </div>
