        ...
        <div className="card-body" >
            {props.loadingStatus ?
                <div className={"row justify-content-center"}>
                    <p>
                        Procesando su solicitud de Delete cuenta
                    </p>
  ...
  const color = "#1a5a6e"
    ...
    return (
        <div className="bootstrap-modal" >
            ...
            <button onClick={() => openModal()}  data-bn-type="button" className=" css-2c4swc">Delete</button>
            {/* <!-- Modal --> */}
            <Modal className="fade" show={basicModal} onHide={setBasicModal}>
                <Modal.Header className={"text-center justify-content-center"}>
                    <h4 className="text-black">Delete Cuenta</h4>
                    <Button
                        variant=""
                        className="close"
                        onClick={() => closeModal()}
