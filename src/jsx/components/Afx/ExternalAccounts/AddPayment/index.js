        ...
        <div className="basic-form">
            <form>
                ...
                {formStep == 1 &&
                    <Fragment>
                        <div className="form-group row">
                            <label className="col-sm-3 col-form-label fs-12">Client</label>
                        ...
                        <div className="form-group row">
                            <label className="col-sm-3 col-form-label fs-12">Type</label>
                ...
                {formStep == 2 && type === 'fiat' &&
                    <Fragment>
                        <div className="form-group row"><label className="col-sm-3 col-form-label fs-12">Owner
                        </label>
                            <div className="col-sm-9 px-0">
                        ...
                        <div className="form-group row">
                            <label className="col-sm-3 col-form-label fs-12">Bank</label>
                        ...
                        <div className="form-group row"><label className="col-sm-3 col-form-label fs-12">Number</label>
                            <div className="col-sm-9 px-0">
                        ...
                        <div className="form-group row">
                            <label className="col-sm-3 col-form-label fs-12">ID</label>
                            <div className="col-sm-9 px-0">
        ...
        <div className="bootstrap-modal" >
            ...
            <Modal className="fade" show={basicModal} onHide={setBasicModal} centered>
                <Modal.Header className={"text-center justify-content-center"}>
                    <h4 className="text-black">New Account</h4>
                    <Button
                        variant=""
                        className="close"
                        onClick={() => closeModal()}
                ...
                <Modal.Footer className={"text-center justify-content-center"}>
                    <Button onClick={() => closeModal()} variant="danger light">close</Button>
