...
function ActiveOrders(props) {
    ...
    useEffect(async () => {
            try {
                const response = await axios.get(`orders/${customerId}`).then((res) => {
        ...
        <Fragment>
            ...
            <div className="row justify-content-center mb-4">
                <div className="col-12 text-center">
                    <h3 className={"fc-dark-grey"}>Active Orders</h3>
                </div>
            </div>
                        ...
                        <div className="col-12">
                            ...
                            <Accordion defaultActiveKey="0">
                                <Card.Header className={"fc-DarkGrey pd5"}>
                                    ...
                                    <div className="col-2">Ammount</div>
                                    <div className="col-1">Price</div>
                                    <div className="col-2">Status</div>
                                    <div className="col-1">Trades</div>
