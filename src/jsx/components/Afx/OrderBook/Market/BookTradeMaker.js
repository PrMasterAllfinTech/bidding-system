...
function BookTradeMaker (props){
    ...
    const realCurrentAmount = parseFloat(props.orderData.available).toFixed(2)
    const bankName = props.orderData?.bc_bankname
                    ...
                    <div className="css-cz1u7 row">
                        ...
                        <div className="css-xtcyz1 row">
                            <div className="css-1kvjun2 col-12 fs-12">
                                <div className="row">
                                    <div data-bn-type="text" className="fc-cool-blue font-weight-bolder col-12 mb-1">Precio</div>
                            ...
                            <div className="css-1kvjun2 col-12 fs-12">
                                <div className="row">
                                    <div data-bn-type="text" className="fc-cool-blue font-weight-bolder col-12 mb-1">Disponible</div>
                                    <div data-bn-type="text" className="col-12 fc-DarkGrey">{props.orderData.available} RSV</div>
                                </div>
                            </div>

                            <div className="css-1kvjun2 col-12 fs-12">
                                <div className="row">
                                    <div data-bn-type="text" className="fc-cool-blue font-weight-bolder col-12 mb-1">Método de Pago</div>
                            ...
                            <div className="css-1kvjun2 col-12 fs-12">
                                <div className="row">
                                    <div data-bn-type="text" className="fc-cool-blue font-weight-bolder col-12 mb-1">Tiempo</div>
                ...
                <div className="col-6">
                    <div className="css-1wz0uwi row">
                        ...
                        <div className="col-12 justify-content-center text-center">
                            {!props.bid ?
                                <button data-bn-type="button"
                                        ...
                                        onClick={()=>props.makebid()}
                                >Ofertar
                                </button>
                                :
                                <button data-bn-type="button"
                                        type="button" className="css-s1iig6 fs-10"
                                        onClick={()=>props.cancelbid()}
                                >cancelar
                                </button>
                            }
                        ...
                        {props.bid &&
                            <div className="css-6rvcuk col-12">
                                <div className="css-1om4vs3">
                                    <div data-bn-type="text" className="css-u1xg25 fs-12 text-center">
                                        Tasa</div>
                                    <div className=" css-m4abs">
                                        <input data-bn-type="input" id="C2CofferBuy_quantity_input" aria-label=""
                                               placeholder="0.00" autoComplete="off"
                                               className="css-16fg16t" value={exchange}
                                               onChange={e => setExchange(e.target.value)}
                                        />
                                        <div className="bn-input-suffix css-vurnku">
                                            <div className="css-10nf7hq">
                                                <div data-bn-type="text" className="css-18grlu8">BS</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
