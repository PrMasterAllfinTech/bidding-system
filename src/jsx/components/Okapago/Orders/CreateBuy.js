...
const CreateBuy = () => {
  ...
  const color = "#1a5a6e"
    ...
    const postData = {
        order_type: "0", customer_id: customer_id, rsv_account_id: accountRsv, bc_account_id: accountBank,
                                ...
                                {loader ?
                                    ...
                                    <div className="row">
                                        <div className="container col-lg-6 ">
                                            ...
                                            <div className="form-group  row my-4">
                                                <label className="col-sm-4 text-right col-form-label fs-12">Pagar Desde:
                                                </label>
                                            ...
                                            <div className=" form-group  row my-4">
                                                <label className="col-sm-4  text-right col-form-label fs-12">Recibir Pago:
                                                </label>
