...
import SellIndexedTrades from "./SellOrders-IndexedTrades";
...
export const BuyOrders = (props) => {
    ...
    let bank = props.data.bc_bankname
                ...
                <div className="row">
                    ...
                    <div className="col fc-BlueSec">
                        <p>
                            ...
                            } <p className={"fc-cool-blue fs-12 inlineBlock"}>
                ...
                <div className="container-fluid" className={arrayTrades.length === 0 ? "allfinNone" : null}>
                    <div className="row">
                        <div className="col-12 text-center">
                            ...
                            <div className="row justify-content-center borderBottomGreen fc-cool-blue fs-10">
                                <div className="col-1">
                                    Id
                                </div>
                                <div className="col-1">
...

                            {
                                arrayTrades.map((trade, id) => (
                                        <SellIndexedTrades
                                            ...
                                            setLoader ={value => props.setLoader(value)}
                                            trade={trade}
                                        />
                                    )
                                )
