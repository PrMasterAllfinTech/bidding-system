...
//functions for orders - based on types
    ...
    useEffect(() => {
        (async () => {
            ...
            try {
                ...
                console.log('fail effect sell reload mhp');
            }
        })()
    }, [sellReload]);
    ...
    return (<div className="market-prev row justify-content-center">
        ...
        <div className="col-12 d-flex justify-content-center mt-5 fs-10">
            {props.mainBank}
        </div>

        <div className="col-12 fs-10 my-4 book-prev-left border-bottom-Green">
            <div className="row text-center justify-content-center my-3 fc-cool-blue">
                Ventas
            </div>
            <div className="refresh-orderbook">
                <Refresh setReload={val => setSellReload(val)} setLoader={val => setSellLoader(val)}
                         color={"white"}/>
            </div>
        ...
        <div className="col-12 book-prev-right my-4 border-bottom-Green">
            <div className="row text-center justify-content-center fs-10 my-3 fc-cool-blue">
                Compras
            </div>
            <div className="refresh-orderbook">
