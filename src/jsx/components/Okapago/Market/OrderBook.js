            ...
            <div className="col-12">
                <div className="card">
                    <div className="card-header">
                        <div className="card-title col-sm-12 text-center"><p className="text-center">Order Book!</p>
                        </div>
                    </div>
                                        ...
                                        <div className="row left-orders overflowHidden">
                                            ...
                                            <div className="css-cjwhpx row">
                                                <div className="css-17q4dod fs-12 col">
                                                    <div
                                                        className="col-3 fc-Blue font-weight-bold">Precio
                                                    </div>
                                                    <div
                                                        className="col-3 fc-Blue font-weight-bold">Disponible
                                                    </div>
                                                    <div
                                                        className="col-4 fc-Blue font-weight-bold">Pago
                                                    </div>
                                                    <div className="col text-center fs-10">
