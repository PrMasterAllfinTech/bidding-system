...
import logo from '../../images/otc/afx-ins-lg.png'
...
function Login (props) {
  ...
  return (
        ...
        <div className="container-fluid vh-100" style={{background:"#262624"}}>
            <div className="row vh-100 align-items-center text-center" style={{background:"#262624"}}>
                <div className="col-12" style={{background:"#262624", padding:"10px"}}>

                    <div className="col-4 mb-4 logo-animated">
                            <img src={logo} alt=""  className={"login-logo"}/>
                    </div>
                    <br/><br/>

                    <div className="col-12 " style={{background:"#262624"}}>
                        <div className="row m-0 justify-content-center align-items-center">
                            <div className="col-lg-4">
                                <div className="authincation-content">
                                    <div className="row no-gutters">
                                        <div className="col-xl-12">
                                            <div className="auth-form-1" style={{background:"#262624"}}>
                                                ...
                                                <form onSubmit={onLogin}>
                                                    ...
                                                    <div className="form-group">
                                                        <label className="mb-2 text-white"><strong>Contraseña</strong></label>
                                                        <input
                                                            type="password"
                                                    ...
                                                    <div className="form-row d-flex justify-content-center mt-4 mb-2">
                                                        <div className="form-group">
                                                    ...
                                                    <div className="row justify-content-center">
                                                        <div className="text-center col-8">
                                                            <button
                                                                type="submit"
                                                                className="submit submit-login blueButton fs-12"
                                                            >
                                                                Entrar
                                                            </button>
                                                        </div>
                        ...
                        <div className="col-12 login-description mt-5 d-none" >
