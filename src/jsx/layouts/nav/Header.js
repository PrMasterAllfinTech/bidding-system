...
import reserve from "../../../images/otc/rsv-logo-small.png"
...
const Header = ({ onNote, toggle, onProfile, onNotification, onClick }) => {
	...
	if (localStorage.getItem('userDetails') !== null) {
		userName = savedData.user_data.name
	}else {
		userName= 'Admin'
	}
			...
			<nav className="navbar navbar-expand">
				<div className="collapse navbar-collapse justify-content-between ">
					<div className="header-left ">
						<div
							className="dashboard_bar d-none"
						...
						<div className={"dashboard_bar justify-content-center d-flex allfinNone"}>
							<img src={reserve} alt="reserve-i"/>
						</div>
					</div> 	
					<ul className="navbar-nav header-right">
						...
						<Dropdown as="li" className="nav-item header-profile ">
							...
							<i className="flaticon-381-unlocked-2"></i>
								...
								<Link to="/cuentas-registradas" className="dropdown-item ai-icon" >
									<i className="flaticon-381-unlocked-2"></i>
